...
class FragmentFD(FileDownloader):
    ...
    def report_retry_fragment(self, err, frag_index, count, retries):
        self.deprecation_warning('dankert_install.downloader.FragmentFD.report_retry_fragment is deprecated. '
                                 'Use dankert_install.downloader.FileDownloader.report_retry instead')
