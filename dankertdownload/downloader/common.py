...
class FileDownloader:
    ...
    def parse_bytes(bytestr):
        ...
        deprecation_warning('dankert_install.FileDownloader.parse_bytes is deprecated and '
                            'may be removed in the future. Use dankert_install.utils.parse_bytes instead')
