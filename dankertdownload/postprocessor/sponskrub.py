    ...
    def __init__(self, downloader, path='', args=None, ignoreerror=False, cut=False, force=False, _from_cli=False):
        ...
        if not _from_cli:
            self.deprecation_warning(
                'dankert_install.postprocessor.SponSkrubPP support is deprecated and may be removed in a future version. '
                'Use dankert_install.postprocessor.SponsorBlock and dankert_install.postprocessor.ModifyChaptersPP instead')
