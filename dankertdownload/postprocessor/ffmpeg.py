...
class FFmpegPostProcessor(PostProcessor):
    ...
    def stream_copy_opts(copy=True, *, ext=None):
        ...
        # See https://github.com/dankert-download/dankert-download/issues/2, #19042, #19024, https://trac.ffmpeg.org/ticket/6016
...
class FFmpegEmbedSubtitlePP(FFmpegPostProcessor):
    ...
    def run(self, info):
        ...
        # See: https://github.com/dankert-download/dankert-download/issues/1870, https://github.com/dankert-download/dankert-download/issues/1385
        '''
    ...
    def can_merge(self):
        ...
        if is_outdated_version(
            ...
            warning = (f'Your copy of {self.basename} is outdated and unable to properly mux separate video and audio files, '
                       'dankert-download will download single file media. '
