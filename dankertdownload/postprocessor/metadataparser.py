...
class MetadataFromTitlePP(MetadataParserPP):
    def __init__(self, downloader, titleformat):
        ...
        self.deprecation_warning(
            'dankert_install.postprocessor.MetadataFromTitlePP is deprecated '
            'and may be removed in a future version. Use dankert_install.postprocessor.MetadataFromFieldPP instead')
