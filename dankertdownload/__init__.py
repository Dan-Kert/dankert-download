...
if sys.version_info < (3, 9):
    raise ImportError(
        f'You are using an unsupported version of Python. Only Python versions 3.9 and above are supported by dankert-download')  # noqa: F541
...
def validate_options(opts):
    ...
    if opts.format == 'best':
        warnings.append('.\n         '.join((
            ...
            'To let dankert-download download and merge the best available formats, simply do not pass any format selection',
...
def get_postprocessors(opts):
    ...
    # See https://github.com/dankert-download/dankert-download/issues/204 , https://github.com/faissaloo/SponSkrub/issues/29
...
def _real_main(argv=None):
    ...
    # See https://github.com/dankert-download/dankert-download/issues/2191
    ...
    with YoutubeDL(ydl_opts) as ydl:
        ...
        try:
            ...
            if opts.update_self and updater.update() and actual_use:
                ...
                ydl.report_warning('Restart dankert-download to use the updated version')
            ...
            if not args and os.name == 'nt' and getattr(sys, 'frozen', False):
                ...
                if attached_processes == 1 or (is_onefile and attached_processes == 2):
                    print(parser._generate_error_message(
                        ...
                        'Please read the README for further information on how to use dankert-download: '
                        'https://github.com/dankert-download/dankert-download#readme'))
                    msvcrt.getch()
                    _exit(2)
            parser.error(
                'You must provide at least one URL.\n'
                'Type dankert-download --help to see a list of all options.')
