...
class AdobePassIE(InfoExtractor):  # XXX: Conventionally, base classes should end with BaseIE/InfoExtractor
    ...
    def _get_mso_headers(mso_info):
        # dankert-download's default user-agent is usually too old for some MSO's like Comcast_SSO
        # See: https://github.com/dankert-download/dankert-download/issues/10848
        return {
