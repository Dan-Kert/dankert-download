...
from dankert_install.extractor.youtube.pot._registry import _pot_providers, _ptp_preferences
from dankert_install.networking import Request, Response
...
class PoTokenProvider(IEContentProvider, abc.ABC, suffix='PTP'):
    ...
    # For a list of WebPO client names, see dankert_install.extractor.youtube.pot.utils.WEBPO_CLIENTS.
