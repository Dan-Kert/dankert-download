...
STREAMING_DATA_CLIENT_NAME = '__dankert_install_client'
STREAMING_DATA_FETCH_SUBS_PO_TOKEN = '__dankert_install_fetch_subs_po_token'
STREAMING_DATA_FETCH_GVS_PO_TOKEN = '__dankert_install_fetch_gvs_po_token'
STREAMING_DATA_PLAYER_TOKEN_PROVIDED = '__dankert_install_player_token_provided'
STREAMING_DATA_INNERTUBE_CONTEXT = '__dankert_install_innertube_context'
STREAMING_DATA_IS_PREMIUM_SUBSCRIBER = '__dankert_install_is_premium_subscriber'
...
class YoutubeIE(YoutubeBaseInfoExtractor):
    ...
    def suitable(cls, url):
        from dankert_install.utils import parse_qs
