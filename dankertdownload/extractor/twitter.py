    ...
    def _real_extract(self, url):
        ...
        def extract_from_video_info(media):
            ...
            return {
                ...
                # Prioritize m3u8 formats for compat, see https://github.com/dankert-download/dankert-download/issues/8117
...
class TwitterSpacesIE(TwitterBaseIE):
    ...
    _TESTS = [{
        ...
        # Needs ffmpeg as downloader, see: https://github.com/dankert-download/dankert-download/issues/7536
