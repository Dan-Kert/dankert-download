...
PACKAGE_NAME = 'dankert_install_plugins'
...
def default_plugin_paths():
    ...
    # Load from dankert-download config folders
    yield from _get_package_paths(
        *get_user_config_dirs('dankert-download'),
        *get_system_config_dirs('dankert-download'),
        containing_folder='plugins',
    )

    # Load from dankert-download-plugins folders
    yield from _get_package_paths(
        get_executable_path(),
        *get_user_config_dirs(''),
        *get_system_config_dirs(''),
        containing_folder='dankert-download-plugins',
    )
...
class PluginFinder(importlib.abc.MetaPathFinder):
    ...
    It searches in sys.path and dankert-download config folders for
...
def load_plugins(plugin_spec: PluginSpec):
    ...
    # nor are considered part of the dankert_install_plugins namespace package
