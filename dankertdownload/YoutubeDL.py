...
class YoutubeDL:
    ...
    postprocessors:    A list of dictionaries, each with an entry
                       * key:  The name of the postprocessor. See
                               dankert_install/postprocessor/__init__.py for a list.
    ...
    impersonate:       Client to impersonate for requests.
                       An ImpersonateTarget (from dankert_install.networking.impersonate)
    ...
    the downloader (see dankert_install/downloader/common.py):
    ...
    call_home:         - Not implemented
                       ...
                       dankert-download servers for debugging.
    ...
    def _format_text(self, handle, allow_colors, text, f, fallback=None, *, test_encoding=False):
        ...
        if test_encoding:
            original_text = text
            # handle.encoding can be None. See https://github.com/dankert-download/dankert-download/issues/2711
    ...
    def prepare_outtmpl(self, outtmpl, info_dict, sanitize=False):
        ...
        def get_value(mdict):
            ...
            # XXX: Workaround for https://github.com/dankert-download/dankert-download/issues/4485
    ...
    def _load_cookies(self, data, *, autoscope=True):
        ...
        See: https://github.com/dankert-download/dankert-download/security/advisories/GHSA-v8mc-9377-rwjj
        ...
        for cookie in LenientSimpleCookie(data).values():
            ...
            if domain:
                ...
                self.report_warning(
                    ...
                    f'If you are using dankert-download with an input URL{bug_reports_message(before=",")}',
                    only_once=True)
    ...
    def __process_playlist(self, ie_result, download):
        ...
        for i, (playlist_index, entry) in enumerate(entries):
            ...
            if self._match_entry(entry_copy, incomplete=True) is not None:
                # For compatabilty with youtube-dl. See https://github.com/dankert-download/dankert-download/issues/4369
        ...
        if not prefer_best and not can_merge():
            ...
            if evaluate_formats('b/bv+ba') != evaluate_formats('bv*+ba/b'):
                self.report_warning('ffmpeg not found. The downloaded format may not be the best available. '
                                    'Installing ffmpeg is strongly recommended: https://github.com/dankert-download/dankert-download#dependencies')
    ...
    def build_format_selector(self, format_spec):
        ...
        #       See: https://github.com/dankert-download/dankert-download/pulls/8797
    ...
    def process_video_result(self, info_dict, download=True):
        ...
        for format_id, ambiguous_formats in formats_dict.items():
            ...
            for i, fmt in enumerate(ambiguous_formats):
                ...
                # See https://github.com/dankert-download/dankert-download/issues/1282
        ...
        try:
            ...
            for ue in e.unsupported_errors:
                ...
                if ue.handler.RH_KEY == 'Urllib' and 'unsupported url scheme: "file"' in ue.msg.lower():
                    raise RequestError(
                        'file:// URLs are disabled by default in dankert-download for security reasons. '
