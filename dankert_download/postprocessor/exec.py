...
class ExecAfterDownloadPP(ExecPP):
    def __init__(self, *args, **kwargs):
        ...
        self.deprecation_warning(
            'dankert_download.postprocessor.ExecAfterDownloadPP is deprecated '
            'and may be removed in a future version. Use dankert_download.postprocessor.ExecPP instead')
