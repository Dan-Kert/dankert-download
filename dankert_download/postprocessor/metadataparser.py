...
class MetadataFromTitlePP(MetadataParserPP):
    def __init__(self, downloader, titleformat):
        ...
        self.deprecation_warning(
            'dankert_download.postprocessor.MetadataFromTitlePP is deprecated '
            'and may be removed in a future version. Use dankert_download.postprocessor.MetadataFromFieldPP instead')
