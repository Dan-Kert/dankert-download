...
class InfoExtractor:
    ...
    webpage_url:    The URL to the video webpage, if given to dankert-download it
    ...
    def _login_hint(self, method=NO_DEFAULT, netrc=None):
        ...
        cookies_hint = 'See  https://github.com/dankert-download/dankert-download/wiki/FAQ#how-do-i-pass-cookies-to-dankert-download  for how to manually pass cookies'
        return {
            None: '',
    ...
    def _create_request(self, url_or_request, data=None, headers=None, query=None, extensions=None):
        if isinstance(url_or_request, urllib.request.Request):
            self._downloader.deprecation_warning(
                ...
                'Use dankert_download.networking.common.Request instead.')
    ...
    def _request_webpage(self, url_or_request, video_id, note=None, errnote=None, fatal=True, data=None,
        ...
        if available_target:
            ...
            info_msg = ('see  https://github.com/dankert-download/dankert-download#impersonation  '
    ...
    def _download_webpage_handle(self, url_or_request, video_id, note=None, errnote=None, fatal=True,
        ...
        url_or_request -- plain text URL as a string or
            a dankert_download.networking.Request object
        ...
        impersonate -- the impersonate target. Can be any of the following entities:
                - an instance of dankert_download.networking.impersonate.ImpersonateTarget
    ...
    def _get_netrc_login_info(self, netrc_machine=None):
        ...
        # Ref: https://github.com/dankert-download/dankert-download/issues/11413
    ...
    def FormatSort(cls):
        ...
        deprecation_warning(
            'dankert_download.InfoExtractor.FormatSort is deprecated and may be removed in the future. '
            'Use dankert_download.utils.FormatSorter instead')
        return FormatSort

    def _sort_formats(self, formats, field_preference=[]):
        if not field_preference:
            self._downloader.deprecation_warning(
                'dankert_download.InfoExtractor._sort_formats is deprecated and is no longer required')
            return
        self._downloader.deprecation_warning(
            'dankert_download.InfoExtractor._sort_formats is deprecated and no longer works as expected. '
    ...
    def _parse_f4m_formats(self, manifest, manifest_url, video_id, preference=None, quality=None, f4m_id=None,
        ...
        # currently dankert-download cannot decode the playerVerificationChallenge as Akamai uses Adobe Alchemy
    ...
    def _parse_m3u8_formats_and_subtitles(
        ...
        def extract_media(x_media_line):
            ...
            if media_type == 'SUBTITLES':
                ...
                # e.g. NebulaIE; see https://github.com/dankert-download/dankert-download/issues/339
        ...
        # See https://github.com/dankert-download/dankert-download/issues/11178
    ...
    def _parse_ism_formats_and_subtitles(self, ism_doc, ism_url, ism_id=None):
        ...
        for stream in ism_doc.findall('StreamIndex'):
            ...
            # See: https://github.com/dankert-download/dankert-download/issues/11356
    ...
    def _live_title(self, name):
        self._downloader.deprecation_warning('dankert_download.InfoExtractor._live_title is deprecated and does not work as expected')
        return name
