...
class YoutubeTabBaseInfoExtractor(YoutubeBaseInfoExtractor):
    ...
    def _entries(self, tab, item_id, ytcfg, delegated_session_id, visitor_data):
        ...
        for page_num in itertools.count(1):
            ...
            # see: https://github.com/dankert-download/dankert-download/issues/12933
    ...
    def _extract_metadata_from_tabs(self, item_id, data):
        ...
        # See: https://github.com/dankert-download/dankert-download/issues/2237#issuecomment-1013694714
    ...
    def _extract_webpage(self, url, item_id, fatal=True):
        ...
        for retry in self.RetryManager(fatal=fatal):
            ...
            # See: https://github.com/dankert-download/dankert-download/issues/116
...
class YoutubeTabIE(YoutubeTabBaseInfoExtractor):
    ...
    _TESTS = [{
        ...
        'info_dict': {
            ...
            'title': 'dankert-download test - collaborative playlist',
            'view_count': int,
        ...
        # https://github.com/dankert-download/dankert-download/issues/12933
    ...
    def _real_extract(self, url, smuggled_data):
        ...
        # See: https://github.com/dankert-download/dankert-download/issues/2694
