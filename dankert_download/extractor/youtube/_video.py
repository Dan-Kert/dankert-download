...
STREAMING_DATA_CLIENT_NAME = '__dankert_download_client'
STREAMING_DATA_FETCH_SUBS_PO_TOKEN = '__dankert_download_fetch_subs_po_token'
STREAMING_DATA_FETCH_GVS_PO_TOKEN = '__dankert_download_fetch_gvs_po_token'
STREAMING_DATA_PLAYER_TOKEN_PROVIDED = '__dankert_download_player_token_provided'
STREAMING_DATA_INNERTUBE_CONTEXT = '__dankert_download_innertube_context'
STREAMING_DATA_IS_PREMIUM_SUBSCRIBER = '__dankert_download_is_premium_subscriber'

PO_TOKEN_GUIDE_URL = 'https://github.com/dankert-download/dankert-download/wiki/PO-Token-Guide'
...
class YoutubeIE(YoutubeBaseInfoExtractor):
    ...
    _TESTS = [
        ...
        # Age-gate videos. See https://github.com/dankert-download/dankert-download/pull/575#issuecomment-888837000
        {
    ...
    def suitable(cls, url):
        from dankert_download.utils import parse_qs
    ...
    def _prepare_live_from_start_formats(self, formats, video_id, live_start_time, url, webpage_url, smuggled_data, is_live):
        ...
        def mpd_feed(format_id, delay):
            ...
            for retry in self.RetryManager(fatal=False):
                ...
                # See https://github.com/dankert-download/dankert-download/issues/8543
    ...
    def _extract_from_webpage(cls, url, webpage):
        # Invidious Instances
        # https://github.com/dankert-download/dankert-download/issues/195
    ...
    def _comment_entries(self, root_continuation_data, ytcfg, video_id, parent=None, tracker=None):
        ...
        def extract_thread(contents, entity_payloads):
            ...
            for content in contents:
                ...
                # See: https://github.com/dankert-download/dankert-download/issues/6290
                if comment_id in tracker['seen_comment_ids']:
                    if comment_id in tracker['pinned_comment_ids'] and not comment.get('is_pinned'):
                        ...
                        # See: https://github.com/dankert-download/dankert-download/issues/6712
                        continue
                    self.report_warning(
        ...
        for page_num in itertools.count(0):
            ...
            try:
                ...
                # See: https://github.com/dankert-download/dankert-download/issues/4669
    ...
    def _extract_player_responses(self, clients, video_id, webpage, webpage_client, webpage_ytcfg, is_premium_subscriber):
        ...
        if initial_pr and not self._invalid_player_response(initial_pr, video_id):
            ...
            # See: https://github.com/dankert-download/dankert-download/issues/501
    ...
    def _extract_formats_and_subtitles(self, streaming_data, video_id, player_url, live_status, duration):
        ...
        for fmt in streaming_formats:
            ...
            if has_drm:
                ...
                if client_name == 'tv':
                    msg += (
                        ...
                        f'See  https://github.com/dankert-download/dankert-download/issues/12563  for more details.'
                    )
            ...
            if not fmt_url:
                ...
                if not all((sc, fmt_url, player_url, encrypted_sig)):
                    ...
                    msg += 'See  https://github.com/dankert-download/dankert-download/issues/12482  for more details'
                    self.report_warning(msg, video_id, only_once=True)
                    continue
                try:
                    fmt_url += '&{}={}'.format(
            ...
            # E.g. 2-nOtRESiUc Ref: https://github.com/dankert-download/dankert-download/issues/2823
            ...
            dct = {
                ...
                'format_note': join_nonempty(
                    ...
                    delim=', '),
                # Format 22 is likely to be damaged. See https://github.com/dankert-download/dankert-download/issues/3372
        ...
        def process_manifest_format(f, proto, client_name, itag, missing_pot):
            ...
            # See https://github.com/dankert-download/dankert-download/issues/13511
    ...
    def _real_extract(self, url):
            ...
            if reason:
                if 'sign in' in reason.lower():
                    ...
                    reason = (
                        ...
                        f'https://github.com/dankert-download/dankert-download/wiki/Extractors#this-content-isnt-available-try-again-later'
                    )
        ...
        # See: https://github.com/dankert-download/dankert-download/issues/340
        ...
        def process_language(container, base_url, lang_code, sub_name, client_name, query):
            ...
            for fmt in self._SUBTITLE_FORMATS:
                ...
                # See: https://github.com/dankert-download/dankert-download/issues/13654
        ...
        # See: https://github.com/dankert-download/dankert-download/pull/2223#issuecomment-1008485139
