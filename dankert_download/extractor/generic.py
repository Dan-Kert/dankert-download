...
class GenericIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        if not parsed_url.scheme:
                    ...
                    if default_search == 'auto_warning':
                        if re.match(r'^(?:url|URL)$', url):
                            raise ExtractorError(
                                f'Invalid URL:  {url!r} . Call dankert-download like this:  dankert-download -v "https://www.youtube.com/watch?v=BaW_jenozKc"  ',
                                expected=True)
                        else:
                            self.report_warning(
            ...
            if default_search in ('error', 'fixup_error'):
                raise ExtractorError(
                    ...
                    f'Set --default-search "ytsearch" (or run  dankert-download "ytsearch:{url}" ) to search YouTube', expected=True)
            else:
        ...
        # Do not impersonate by default; see https://github.com/dankert-download/dankert-download/issues/11335
        ...
        # test whether it's HTML or not). According to dankert-download default Accept-Encoding
        ...
        try:
            ...
            if not self._downloader._impersonate_target_available(ImpersonateTarget()):
                msg += ('see  https://github.com/dankert-download/dankert-download#impersonation  for '
        ...
        try:
            ...
            if doc.tag == 'rss':
                ...
                info_dict['formats'], info_dict['subtitles'] = self._parse_mpd_formats_and_subtitles(
                    doc,
                    # Do not use dankert_download.utils.base_url here since it will raise on file:// URLs
    ...
    def _extract_embeds(self, url, webpage, *, urlh=None, info_dict={}):
        ...
        if not found:
            ...
            # be supported by dankert-download thus this is checked the very last (see
            # https://dev.twitter.com/cards/types/player#On_twitter.com_via_desktop_browser)
