...
An attribute "_dankert_download__identifier" may be inserted into the module if it uses an ambiguous namespace"""
...
try:
    import sqlite3
    # We need to get the underlying `sqlite` version, see https://github.com/dankert-download/dankert-download/issues/8152
    sqlite3._dankert_download__version = sqlite3.sqlite_version
except ImportError:
    # although sqlite3 is part of the standard library, it is possible to compile Python without
    # sqlite support. See: https://github.com/dankert-download/dankert-download/issues/544
    sqlite3 = None
...
try:
    ...
    if hasattr(xattr, 'set'):  # pyxattr
        xattr._dankert_download__identifier = 'pyxattr'
