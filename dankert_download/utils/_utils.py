        ...
        try:
            try:
                if sys.platform == 'win32':
                    ...
                    # Ref: https://github.com/dankert-download/dankert-download/issues/3124
...
def sanitize_filename(s, restricted=False, is_id=NO_DEFAULT):
    ...
    @param is_id        Whether this is an ID that should be kept unchanged if possible.
                        If unset, dankert-download's new sanitization rules are in effect
    """
    if s == '':
        return ''
...
class Popen(subprocess.Popen):
    ...
    def _fix_pyinstaller_issues(env):
        ...
        #      https://github.com/dankert-download/dankert-download/issues/11259
        env['PYINSTALLER_RESET_ENVIRONMENT'] = '1'

        # Restore LD_LIBRARY_PATH when using PyInstaller
        # Ref: https://pyinstaller.org/en/v6.10.0/runtime-information.html#ld-library-path-libpath-considerations
        #      https://github.com/dankert-download/dankert-download/issues/4573
        def _fix(key):
...
def bug_reports_message(before=';'):
    ...
    msg = (f'please report this issue on  https://github.com/{REPOSITORY}/issues?q= , '
           'filling out the appropriate issue template. Confirm you are on the latest version using  dankert-download -U')
...
class ExtractorError(YoutubeDLError):
    ...
    def __init__(self, msg, tb=None, expected=False, cause=None, video_id=None, ie=None):
        ...
        If expected is set, this is a normal error message and most likely not a bug in dankert-download.
        """
...
def write_string(s, out=None, encoding=None):
    ...
    enc, buffer = None, out
    # `mode` might be `None` (Ref: https://github.com/dankert-download/dankert-download/issues/8816)
...
def setproctitle(title):
    ...
    # Workaround for https://github.com/dankert-download/dankert-download/issues/4541
    try:
        import ctypes
    except ImportError:
        return
...
def strftime_or_none(timestamp, date_format='%Y%m%d', default=None):
    ...
    try:
        if isinstance(timestamp, (int, float)):  # unix timestamp
            ...
            # Ref: https://github.com/dankert-download/dankert-download/issues/5185, https://github.com/python/cpython/issues/94414
            # Also, dt.datetime.fromtimestamp breaks for negative timestamps
            # Ref: https://github.com/dankert-download/dankert-download/issues/6706#issuecomment-1496842642
...
def _get_exe_version_output(exe, args):
    try:
        ...
        # SIGTTOU if dankert-download is run in the background.
...
def ytdl_is_updateable():
    """ Returns if dankert-download can be updated with -U """
...
def dfxp2srt(dfxp_data):
    ...
    # Fix UTF-8 encoded file wrongly marked as UTF-16. See https://github.com/dankert-download/dankert-download/issues/6543#issuecomment-1477169870
...
def write_xattr(path, key, value):
    ...
    elif getattr(xattr, '_dankert_download__identifier', None) == 'pyxattr':
    ...
    def load_configs(self):
        ...
        for location in opts.config_locations or []:
            ...
            if os.path.isdir(location):
                location = os.path.join(location, 'dankert-download.conf')
...
class _UnsafeExtensionError(Exception):
    ...
    Ref: https://github.com/dankert-download/dankert-download/security/advisories/GHSA-79w7-vh3h-8g4j
    """
...
class FormatSorter:
    ...
    def _fill_sorting_fields(format):
        ...
        if format.get('preference') is None and format.get('ext') == 'flv' and re.match('[hx]265|he?vc?', format.get('vcodec') or ''):
            ...
            # ref. https://github.com/dankert-download/dankert-download/pull/5821
