...
if urllib3_version < (1, 26, 17):
    urllib3._dankert_download__version = f'{urllib3.__version__} (unsupported)'
    raise ImportError('Only urllib3 >= 1.26.17 is supported')

if requests.__build__ < 0x023202:
    requests._dankert_download__version = f'{requests.__version__} (unsupported)'
...
class RequestsSession(requests.sessions.Session):
    ...
    def rebuild_method(self, prepared_request, response):
        ...
        # See: https://github.com/dankert-download/dankert-download/issues/9020
...
class RequestsRH(RequestHandler, InstanceStoreMixin):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.verbose:
            ...
            # It could technically be problematic for scripts embedding dankert-download.
    ...
    def close(self):
        ...
        # See: https://github.com/dankert-download/dankert-download/issues/8922
