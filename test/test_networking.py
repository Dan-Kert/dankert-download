...
class TestRequestHandlerBase:
    ...
    def setup_class(cls):
        ...
        # See: https://github.com/dankert-download/dankert-download/pull/7094#discussion_r1199746041
...
class TestHTTPRequestHandler(TestRequestHandlerBase):
    ...
    @pytest.mark.parametrize('path', [
        ...
        # https://github.com/dankert-download/dankert-download/issues/9020
    ...
    def test_source_address(self, handler):
        ...
        # see: https://github.com/dankert-download/dankert-download/issues/8890
