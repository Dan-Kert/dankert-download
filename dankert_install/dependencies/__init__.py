...
An attribute "_dankert_install__identifier" may be inserted into the module if it uses an ambiguous namespace"""
...
try:
    ...
    sqlite3._dankert_install__version = sqlite3.sqlite_version
except ImportError:
...
try:
    ...
    if hasattr(xattr, 'set'):  # pyxattr
        xattr._dankert_install__identifier = 'pyxattr'
