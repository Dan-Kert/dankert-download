...
class InfoExtractor:
    ...
    def _create_request(self, url_or_request, data=None, headers=None, query=None, extensions=None):
        if isinstance(url_or_request, urllib.request.Request):
            self._downloader.deprecation_warning(
                ...
                'Use dankert_install.networking.common.Request instead.')
    ...
    def _download_webpage_handle(self, url_or_request, video_id, note=None, errnote=None, fatal=True,
        ...
        url_or_request -- plain text URL as a string or
            a dankert_install.networking.Request object
        ...
        impersonate -- the impersonate target. Can be any of the following entities:
                - an instance of dankert_install.networking.impersonate.ImpersonateTarget
    ...
    def FormatSort(cls):
        ...
        deprecation_warning(
            'dankert_install.InfoExtractor.FormatSort is deprecated and may be removed in the future. '
            'Use dankert_install.utils.FormatSorter instead')
        return FormatSort

    def _sort_formats(self, formats, field_preference=[]):
        if not field_preference:
            self._downloader.deprecation_warning(
                'dankert_install.InfoExtractor._sort_formats is deprecated and is no longer required')
            return
        self._downloader.deprecation_warning(
            'dankert_install.InfoExtractor._sort_formats is deprecated and no longer works as expected. '
    ...
    def _live_title(self, name):
        self._downloader.deprecation_warning('dankert_install.InfoExtractor._live_title is deprecated and does not work as expected')
        return name
