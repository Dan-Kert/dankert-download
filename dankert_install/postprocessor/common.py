...
class PostProcessor(metaclass=PostProcessorMetaClass):
    ...
    def report_error(self, text, *args, **kwargs):
        self.deprecation_warning('"dankert_install.postprocessor.PostProcessor.report_error" is deprecated. '
                                 'raise "dankert_install.utils.PostProcessingError" instead')
        if self._downloader:
