...
class ExecAfterDownloadPP(ExecPP):
    def __init__(self, *args, **kwargs):
        ...
        self.deprecation_warning(
            'dankert_install.postprocessor.ExecAfterDownloadPP is deprecated '
            'and may be removed in a future version. Use dankert_install.postprocessor.ExecPP instead')
